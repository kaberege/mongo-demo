...
import { userRegister, userLogin, tokenRefreshRotation, userLogout, forgotPassword, resetPassword, updateProfile, deleteProfile, adminModifyRole, } from "../controllers/user.js";
...
router.post("/register", [
    ...
    body("password")
        .trim()
        .isLength({ min: 8 })
        .withMessage("Password requires an 8-character floor complexity constraint."),
    body("name")
        .trim()
        .notEmpty()
...
router.patch("/admin/role/:userId", isAuth, checkRole(["admin"]), [
    body("role")
        .trim()
        .notEmpty()
        .isIn(["user", "editor", "admin"])
        .withMessage("Invalid role specified"),
], validateRequest, adminModifyRole);
